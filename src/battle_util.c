...
void CopyMonAbilityAndTypesToBattleMon(u32 battler, struct Pokemon *mon)
{
    ...
    gBattleMons[battler].ability = GetPartyDataFromBattler(battler, MON_DATA_ABILITY);
}

void FillBattlerTypesFromParty(u32 battler)
{
    gBattleMons[battler].type1 = GetPartyDataFromBattler(battler, MON_DATA_TYPE1);
    gBattleMons[battler].type2 = GetPartyDataFromBattler(battler, MON_DATA_TYPE2);  
    gBattleMons[battler].type3 = TYPE_MYSTERY;  
}

u32 GetPartyDataFromBattler(u32 battlerId, u32 data)
{
